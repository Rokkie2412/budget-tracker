import { CountryCode } from "@/components/ui/inputForm/inputForm.types";

import { EXPENSE_KEYWORD_MAP } from "./expenseKeyword";
import { INCOME_KEYWORD_MAP } from "./incomeKeyword";
...
export { EXPENSE_KEYWORD_MAP, INCOME_KEYWORD_MAP };
