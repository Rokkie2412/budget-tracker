...
const SearchEmptyIllustration = (): React.JSX.Element => {
  return (
    <View className="relative items-center justify-center w-44 h-44">
      <Svg height="176" width="176" viewBox="0 0 176 176" style={styles.svgAbsolute}>
...
const EmptyIllustration = ({
  ...
  if (customIcon) {
    return <View className="items-center justify-center mb-3">{customIcon}</View>;
  }
...
export const EmptyState = ({
  ...
  return (
    ...
    >
      ...
      <Text className="text-xl font-bold text-[#20304E] text-center mt-2 mb-2">{displayTitle}</Text>
