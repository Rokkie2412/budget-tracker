...
import styles, { BASE_COLOR } from "./errorState.styles";
import { ErrorStateProps, ErrorVariant } from "./errorState.types";
...
const ErrorIllustration = ({
  ...
  return (
    <View className="relative items-center justify-center w-52 h-52">
      ...
      <Svg height="208" width="208" viewBox="0 0 208 208" style={styles.svgAbsolute}>
...
export const ErrorState = ({
  ...
  return (
    <View className={`flex-1 w-full justify-center items-center px-6 py-8 ${className}`}>
      {/* Unique Visual Illustration */}
      {showIconBadge && <ErrorIllustration variant={variant} customIcon={icon} />}
